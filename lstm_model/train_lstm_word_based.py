...
EMBEDDING_DIM_2 = 1000     # 第二层lstm的输出维度
...
def model_lstm(X_train, X_val, y_train, y_val, word_to_index):
    ...
    adam = Adam(lr=0.0005, beta_1=0.9, beta_2=0.99, epsilon=1e-08)
    ...
    tensorboard = TensorBoard(log_dir="./tensorboard_log5/")
    # save best model.
    checkpoint = ModelCheckpoint(filepath='./checkpoint/model_epoch50_2lstm_1dense_seq50_phrase_based_best1.h5',
    ...
    model.save('./checkpoint/model_epoch50_2lstm_1dense_seq50_phrase_based_best1.h5')
...
if __name__ == '__main__':
    file_name = "./data_crawl/all_5.txt"
